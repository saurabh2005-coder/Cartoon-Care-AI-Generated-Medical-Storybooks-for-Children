...
# Alias used by migrate.py and other scripts
...
# and so their tables are registered with Base.metadata before create_all runs.
import models.story_model  # noqa: F401 — registers Story & StoryPage tables
import models.user_model   # noqa: F401 — registers User table
